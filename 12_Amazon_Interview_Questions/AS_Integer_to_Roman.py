...
def main():
    sol = Solution()
    print("58:  {}".format(sol.intToRoman(58)))
    print("1994:  {}".format(sol.intToRoman(1994)))
    print("3:  {}".format(sol.intToRoman(3)))
    print("9:  {}".format(sol.intToRoman(9)))
    print("4:  {}".format(sol.intToRoman(4)))
    print("19900:  {}".format(sol.intToRoman(19900)))
